...
public class RecyclerviewGridCategories extends RecyclerView.Adapter {

    String personNames;
    String personImages;
    Context context;

    public RecyclerviewGridCategories(Context context, String personNames, String personImages) {
